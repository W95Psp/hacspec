...
let chacha20_line (a_0 b_1 d_2: state_idx_t) (s_3: uint_size {s_3 > 0 /\ s_3 < 32}) (m_4: state_t) : state_t =
  let state_5 = m_4 in
  let state_5 =
...
let chacha20_encrypt_last (st0_45: state_t) (ctr_46: uint32) (plain_47: byte_seq {seq_len plain_47 < 64}) : byte_seq =
